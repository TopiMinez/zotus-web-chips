...
for (var i = 0, k = 0, l = gdjs.ChipsCode.GDClickObjectObjects2.length;i<l;++i) {
    if ( gdjs.ChipsCode.GDClickObjectObjects2[i].getBehavior("ButtonFSM").IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.ChipsCode.GDClickObjectObjects2[k] = gdjs.ChipsCode.GDClickObjectObjects2[i];
        ++k;
    }
}
gdjs.ChipsCode.GDClickObjectObjects2.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.ChipsCode.GDClickObjectObjects2 */
...
}{for(var i = 0, len = gdjs.ChipsCode.GDClickObjectObjects2.length ;i < len;++i) {
    gdjs.ChipsCode.GDClickObjectObjects2[i].deleteFromScene(runtimeScene);
}
}}
